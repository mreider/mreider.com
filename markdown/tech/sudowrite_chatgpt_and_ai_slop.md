...
But ChatGPT is too general-purpose. It's not built specifically for writers, and often I find its tone and content to be the familiarly exhausting brand of bullshit known as "corporate-speak." It also takes a lot of prompting and arguing to get what you want. This led me to [Sudowrite](https://sudowrite.com), which is built on language models like GPT, but devoted to and designed for authors.
